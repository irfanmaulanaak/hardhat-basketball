...
contract Marketplace is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function sell(address nftAddress, uint256 tokenID, uint256 price, string memory transactionID, Sig memory sellRSV) public{
    ...
    function buy(Buy memory buyStruct, Sig memory buyRSV, uint256 totalFee) public payable  {
    ...
    function cancelSell(address nftAddress, uint256 tokenID, string memory transactionID, Sig memory cancelRSV) public {
    ...
    function changePrice(address nftAddress, uint256 tokenID, uint256 newPrice, string memory transactionID, Sig memory changePriceRSV) public {
